...
/**
 * Manages the clipboard panel — history tracking, saved clips, paste/delete actions.
 * Extracted from KeyboardView for single-responsibility.
 */
class KeyboardClipboardManager(
    ...
    private fun refreshPanel() {
        refreshClipList(clipboardListContainer, clipHistory, isSaved = false)
        refreshClipList(savedClipboardListContainer, savedClipHistory, isSaved = true)
    }

    private fun refreshClipList(container: LinearLayout?, clips: MutableList<String>, isSaved: Boolean) {
        container ?: return
